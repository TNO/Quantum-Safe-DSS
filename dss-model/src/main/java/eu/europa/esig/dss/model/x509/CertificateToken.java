...
public class CertificateToken extends Token {
	...
	private final EntityIdentifier entityKey2; //TODO add this
	...
	public CertificateToken(X509Certificate x509Certificate) {
		...
		this.entityKey = new EntityIdentifier(x509Certificate.getPublicKey()); // TODO change to x509holder.getSubjectPublicKey().getPublicKey().getEncoded();
		// TODO try catch
		this.entityKey2 = new EntityIdentifier(x509Certificate.getPublicKey()); // TODO x509holder.getSubjectAltPublicKey().getPublicKey().getEncoded();
...
//		this.signatureAlgorithm2 = SignatureAlgorithm.forOidAndParams(x509Certificate.getSigAlgOID(), x509Certificate.getSigAlgParams()); // TODO change a bit
	...
	public EntityIdentifier getEntityKey() {
		return entityKey;
	} // TODO get getter for new entity key
	 ...
	 */
	@Override
	public boolean isSelfSigned() { //TODO do the same check for alt pub
		if (selfSigned == null) {
	 ...
	 */
	public boolean isEquivalent(CertificateToken token) { // TODO add alt pub
