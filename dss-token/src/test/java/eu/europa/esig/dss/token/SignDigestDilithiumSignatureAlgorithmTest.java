...
public class SignDigestDilithiumSignatureAlgorithmTest {
    ...
    private static Collection<SignatureAlgorithm> data() {
        Collection<SignatureAlgorithm> dilithiumCombinations = new ArrayList<>();
        for (DigestAlgorithm digestAlgorithm : DigestAlgorithm.values()) {
            SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.getAlgorithm(EncryptionAlgorithm.DILITHIUM2, digestAlgorithm);
            if (signatureAlgorithm != null) {
                dilithiumCombinations.add(signatureAlgorithm);
            }
        }
        return dilithiumCombinations;
    }
